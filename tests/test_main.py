...
from python_can_viewer import KEY_ESC, KEY_SPACE, CanViewer, canopen_function_codes, CANOPEN_NMT, CANOPEN_SYNC_EMCY, \
...
class CanViewerTest(unittest.TestCase):
    ...
    def test_parse_args(self):
        ...
        parsed_args, _, _, ignore_canopen = parse_args(['-i', 'virtual'])
        self.assertFalse(parsed_args.ignore_canopen)
        self.assertFalse(ignore_canopen)

        parsed_args, _, _, ignore_canopen = parse_args(['-i', 'virtual', '--ignore-canopen'])
